% read_simple_radiograph.m: Template for reading Simple Radiographs
...
assert(isa(rad, 'SimpleRadiograph'));
...
%     For example, protons can be specified as just â€œp+â€?, and electrons by "e-". Any arbitrary isotope of Hydrogen can be specified â€œ H-I q+â€? where I is the mass number and q is the charge.
%
